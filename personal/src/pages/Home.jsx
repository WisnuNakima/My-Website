...
function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Calculate path progress based on timeline section scroll
      if (timelineRef.current) {
        ...
        // Complete animation when section is almost scrolled through
        const scrollStart = windowHeight * 0.8 // Start earlier for smoother entry
        const scrollEnd = -sectionHeight + windowHeight * 0.3 // End later
  ...
  return (
    <div className="app">
      ...
      {/* Social Media Sidebar - Only visible in section 1 */}
      <div className={`social-sidebar ${scrolled ? 'hidden' : ''}`}>
        <div className="social-line"></div>
        <a href="https://www.linkedin.com/in/wisnu-nakima-70884340a/" target="_blank" rel="noopener noreferrer" className="social-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
          </svg>
        </a>
        <a href="https://wa.me/6281212264997" target="_blank" rel="noopener noreferrer" className="social-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://github.com/WisnuNakima" target="_blank" rel="noopener noreferrer" className="social-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <PageTransition>
        <HeroSection />
        <AboutSection scrolled={scrolled} />
        <EducationSection pathProgress={pathProgress} timelineRef={timelineRef} />
        <AboutMeSection />
        <ProjectsSection />
        <InterestsSection />
        <FooterSection localTime={localTime} />
      </PageTransition>
    </div>
  )
}
